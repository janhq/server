...
func CreateApplication() (*Application, error) {
	...
	userHandler := userhandler.NewUserHandler(userService, apiKeyService)
	conversationAPI := conversations.NewConversationAPI(conversationHandler, userHandler)
	...
	conversationsConversationAPI := conversations2.NewConversationAPI(conversationHandler, userHandler)
