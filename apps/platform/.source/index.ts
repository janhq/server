...
export const docs = _runtime.docs<typeof _source.docs>(
  [
    ...
    },
    {
      info: {
        ...
        fullPath: 'content/docs/architecture/test-flows.mdx',
      },
      data: docs_14,
    },
    {
    ...
    {
      info: { path: 'configuration/index.mdx', fullPath: 'content/docs/configuration/index.mdx' },
      data: docs_17,
    },
    {
      info: {
    ...
    {
      info: { path: 'conventions/workflow.mdx', fullPath: 'content/docs/conventions/workflow.mdx' },
      data: docs_24,
    },
    {
      info: {
    ...
    {
      info: { path: 'guides/kong-plugins.mdx', fullPath: 'content/docs/guides/kong-plugins.mdx' },
      data: docs_32,
    },
    {
      info: {
    ...
    {
      info: { path: 'guides/testing.mdx', fullPath: 'content/docs/guides/testing.mdx' },
      data: docs_39,
    },
    {
      info: {
        path: 'guides/troubleshooting.mdx',
        fullPath: 'content/docs/guides/troubleshooting.mdx',
      },
      data: docs_40,
    },
    {
    ...
    {
      info: { path: 'runbooks/monitoring.mdx', fullPath: 'content/docs/runbooks/monitoring.mdx' },
      data: docs_45,
    },
    {
      info: {
    ...
    },
    {
      info: {
        ...
        fullPath: 'content/docs/api-reference/admin-model-api/models/catalogs/bulk-toggle/post.mdx',
      },
      data: docs_83,
    },
    {
  ...
  [
    ...
    {
      info: { path: 'api-reference/meta.json', fullPath: 'content/docs/api-reference/meta.json' },
      data: {
        title: 'API Reference',
        pages: [
          'introduction',
