...
import { Loader2, Trash2, Copy, Plus, AlertTriangle, X } from 'lucide-react'
                            ...
                            {apiKeys.map((key) => (
                                <div key={key.id} className="grid grid-cols-12 gap-4 p-4 text-sm items-center">
                                    ...
                                    <div className="col-span-3 font-mono text-xs text-muted-foreground truncate">
                                        {key.prefix && key.suffix ? `${key.prefix}...${key.suffix}` : (key.key ? key.key : 'sk-...' + key.id.slice(-4))}
                                    </div>
                        ...
                        {!createdKey ? (
                            <>
                                ...
                                <div className="space-y-6 mt-6">
                                    <div className="space-y-2">
                                        <label htmlFor="key-name" className="block text-sm font-medium mb-2">Name</label>
                                        <input
                                            id="key-name"
                                            type="text"
                            ...
                            <>
                                ...
                                <div className="space-y-6 mt-6">
                                    <p className="text-sm text-muted-foreground">
                                        Please save this secret key somewhere safe and accessible. For security reasons, <strong>you will not be able to view it again</strong> through your account. If you lose this secret key, you will need to generate a new one.
                                    </p>
                                    ...
                                    <div className="space-y-3 pt-4 border-t">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <button
                                                    onClick={() => copyToClipboard(`curl https://api.jan.ai/v1/models -H "Authorization: Bearer ${createdKey}"`)}
                                                    className="absolute right-2 top-2 p-1 text-muted-foreground hover:text-foreground"
                                                    title="Copy to clipboard"
                                                >
                                                    <Copy className="h-4 w-4" />
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
                    <div className="w-full max-w-md rounded-lg border bg-background p-6 shadow-lg">
                        ...
                        <div className="space-y-4">
                            <p className="text-sm text-muted-foreground">
                                This API key will immediately be disabled. API requests made using this key will be rejected, which could cause any systems still relying on it to break. Once revoked, you'll no longer be able to view or modify this API key.
                            </p>
