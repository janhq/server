---
title: "User Settings & Personalization Guide"
---
...
Retrieve authenticated user's settings. See [User Settings API](../api/llm-api/README#user-settings) for complete reference.
...
- [User Settings API Reference](../api/llm-api/README#user-settings) - Complete API reference
- [Conversation Management](conversation-management) - Managing your conversations
- [LLM API Documentation](../api/llm-api/) - Main API reference
- [Authentication Guide](authentication) - Getting tokens and keys
