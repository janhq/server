---
title: "Webhooks & Event Integration Guide"
---
...
See [Monitoring & Troubleshooting Guide](./monitoring-advanced) for webhook monitoring and [MCP Custom Tools Guide](./mcp-custom-tools) for tool event integration.
