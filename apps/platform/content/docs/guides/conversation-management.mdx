...
- [LLM API Reference](../api/llm-api/) - Complete API endpoints
- [Chat Completions](../api/llm-api/README#chat-completions) - Send messages with AI responses
- [User Settings](./user-settings-personalization) - Personalize responses
- [Projects Management](../api/llm-api/README#projects) - Organize conversations
