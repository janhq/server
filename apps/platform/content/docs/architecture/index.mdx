...
1. **[System Design](system-design)** - How all the pieces fit together
2. **[Services](services)** - What each service does
3. **[Data Flow](data-flow)** - How requests move through the system
4. **[Security](security)** - How we keep things secure
5. **[Observability](observability)** - How we monitor and debug
6. **[Test Flows](test-flows)** - How we test everything
...
**Helpful references:**
- [Kubernetes Setup Guide](../../k8s/SETUP) - minikube/bootstrap walkthrough
- [Kubernetes README](../../k8s/) - Helm values, ingress, TLS
- [Deployment Guide](../guides/deployment) - Docker, hybrid, CI/CD instructions

## References

- [System Design Details](system-design)
- [Service Configurations](services)
- [Data Flow Patterns](data-flow)
- [Security Model](security)
- [Observability Guide](observability)
- [Test Flows & Diagrams](test-flows)
- [API Reference](../api/)
