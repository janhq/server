---
title: Quick Start
description: Get Jan Server running in 5 minutes
full: false
---
...
- [Getting Started Guide](/docs/getting-started/installation) - Detailed installation and configuration
- [API Documentation](/docs/api-reference/introduction) - Complete API reference
...
- [Testing Guide](/docs/guides/testing) - Platform-specific validation steps
