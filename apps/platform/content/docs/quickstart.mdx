---
title: "Getting Started with Jan Server"
---
...
> - [Kubernetes Setup Guide](../k8s/SETUP) - Complete step-by-step Kubernetes deployment
> - [Deployment Guide](guides/deployment) - All deployment options (Kubernetes, Docker Compose, Hybrid)
...
- Environment templates (Docker/Kubernetes) are documented in [Configuration System](configuration/)
...
2. **Learn Development**:
 ...
 - [Development Guide - Dev-Full Mode](guides/development#dev-full-mode-hybrid-debugging) (recommended for development)
