...
> 
> **For structure:** See [architecture-patterns.md](architecture-patterns) 
> **For workflow:** See [workflow.md](workflow) 
> **Quick reference:** See [conventions.md](conventions)
...
**See also:**
- [architecture-patterns.md](architecture-patterns) - Structure & layers
- [workflow.md](workflow) - Git, testing, deployment
- [conventions.md](conventions) - Quick TL;DR reference
