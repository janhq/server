...
1. [Getting Started (5 minutes)](getting-started/README.md) - Run everything with Docker Compose.
...
### Phase 3A: Advanced Feature Guides (NEW! v0.0.14)
...
### Phase 3B: API Documentation & Examples (v0.0.14)
...
### Phase 4A: SDK & Advanced Patterns (NEW! v0.0.14)
...
### Phase 4B: Operations & Compliance (NEW! v0.0.14)
...
- Primary services covered: LLM API, Response API, Media API, MCP Tools.
...
- Keep a single quick-start at `getting-started/README.md`; avoid parallel setup docs.
