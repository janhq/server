...
func CreateApplication() (*Application, error) {
	...
	chatHandler := chathandler.NewChatHandler(inferenceProvider, providerHandler, conversationHandler, conversationService, projectService, resolver, mediaclientClient, processorImpl, memoryHandler, usersettingsService)
