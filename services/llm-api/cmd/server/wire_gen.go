...
func CreateApplication() (*Application, error) {
	...
	presigner := infrastructure.ProvideMediaPresigner(config, zerologLogger)
	shareHandler := sharehandler.NewShareHandler(shareService, conversationHandler, config, presigner)
