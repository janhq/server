...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.DeletedAt = field.NewTime(tableName, "deleted_at")
	...
	_project.Instruction = field.NewString(tableName, "instruction")
	_project.Favorite = field.NewBool(tableName, "favorite")
	_project.ArchivedAt = field.NewTime(tableName, "archived_at")
	_project.LastUsedAt = field.NewTime(tableName, "last_used_at")
...
func (p *project) updateTableName(table string) *project {
	...
	p.Instruction = field.NewString(table, "instruction")
	p.Favorite = field.NewBool(table, "favorite")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["instruction"] = p.Instruction
	p.fieldMap["favorite"] = p.Favorite
